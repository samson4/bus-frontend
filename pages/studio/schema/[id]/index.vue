      ...
      <div class="bg-white border-r border-gray-200 flex flex-col">
        ...
        <div class="p-6 border-b border-gray-200 sticky">
          <div class="flex items-center space-x-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">{{ route.params.id }}</p>
            </div>
          </div>
        ...
        <div class="p-4 border-t border-gray-200 bg-gray-50">
          <div class="flex items-center justify-between text-xs text-gray-500">
            <span>Schema: {{ route.params.id }}</span>
...
const fetchTables = async () => {
  try {
    ...
    const schema = route.params.id;
    const tablesResult = await axios.get(
      `tables/?schema=${schema}&limit=${tablesLimit.value}&skip=${offset.value}`
    );
