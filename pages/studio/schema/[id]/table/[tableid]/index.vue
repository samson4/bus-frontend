...
const fetchTableData = async () => {
  ...
  const columnsResponse = await axios.get(
    `/columns/?table=${route.params.tableid}&schema=${route.params.id}`
  );
  ...
  const dataResponse = await axios.get(
    `/data/?schema=${route.params.id}&table=${route.params.tableid}&limit=${dataLimit.value}&skip=${dataOffset.value}`
  );
